Feature: As an Automation Tester, I want to verify that user is able to Complete a contract with Twin Contract Template

    
    Scenario: Verify user is able to Complete Twin Contract and validate user can Generate MRCE for Endorsement
        ...
        Then Select Participants For Twin Contract "<RowNumber>"

                            ### Capacity Details Accordion ###
        And Expand Capacity Section Section for Individual Second Section
        ...
        Then Validate the Syndicate Type Individual
                            ...
                            ### Capacity Details Accordion ###
        And Expand Capacity Section Section for Individual Second Section
        Then Add Syndicate under Capacity Details for Brussels Lead Individual Section "<RowNumber>"
        And Click on Save
    ...
    Scenario: Validate the error when user is not selecting lead for Brussles Twin Contract
