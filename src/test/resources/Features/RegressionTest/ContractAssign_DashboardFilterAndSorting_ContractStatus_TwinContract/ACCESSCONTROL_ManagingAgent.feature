Feature: As an Automation Tester, I want to verify the Access Control for the Managing Agent User Types, using an automated script.

   
    Scenario: Verify access of the Review Task for Managing Agent Read only User Type
        ...
        And Log out from Application
                            ...
                            ### Login as Managing Agent Read Only User ###
    ...
    Scenario: Verify access of the Review Task for Managing Agent Read Write User Type
        ...
        And Log out from Application
                            ...
                            ### Login as Managing Agent Read Write User ###
        And Login as Managing Agent Operator "<RowNumber>"
        ...
        And Navigate to Review Task From Search Contract "<RowNumber>"
                            ...
                            ### Validate Review Task For Service Company user Read Write Permission ###
    ...
    Scenario: Verify access of Create Contract, Retract and Review Returned Task, Create Endorsement for Managing Agent Read only User Type
        ...
        Then Enter Confirmation Date For Capacity for Individual Section "<RowNumber>"
                            ...
                            ### Non-Schedule Accordion ###
        And Expand Non Schedule for Individual Section
        Then Add details to the Non Schedule for Individual Section For Managing Agent "<RowNumber>"
        And Click Continue
        ...
        And Log out from Application
                            ...
                            ### Login As Managing Read Only User ###
        Given Login as Contract Creator "<RowNumber>"
        ...
        Then Validate the Review Return Task For Read Only User "<RowNumber>"
        And Log out from Application
    ...
    Scenario: Verify access for Managing Agent Read Write User Type for Contract Creation, View Contract, Retract and Review Returned Task
        ...
        And Navigate to Review Task From Search Contract "<RowNumber>"
                            ...
                            ### Validate the Review Task Returned For Broker Read Write User###
        Then Validate the Review Return And Retract For Read Write User

                            ### Validate Read Write User can save feedback for Returned Review task ###
        Then Validate Read Write user can save Feedback for Returned Review task "<RowNumber>"
        And Log out from Application
    ...
    Scenario: Verify access of Create Contract, Retract and Review Returned Task for Managing Agent Read Write Submit User Type
        ...
        And Navigate to Review Task From Search Contract "<RowNumber>"
                            ...
                            ### Validate Create Contract Task for Broker Read Write Submit Permission ###
        ...
        And Navigate to Review Task From Search Contract "<RowNumber>"
                            ...
                            ### Validate the Review Return Task For Broker Read Write Submit Permission and Agree The Review Returned Task ###
        Then Validate the Review Return and Retract Task For Read Write Submit User "<RowNumber>"
        And Log out from Application                    
