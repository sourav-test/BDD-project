Feature: As an Automation Tester, I want to verify the Task and the Contract Statuses applicable depending upon the present stage, details and activity log of a contract , using an automated script.

    Scenario: Verify the various Task status of a Contract and Document Generation on Actions
        ...
        And Click on Save
                            ...
                            ### Navigate to My Contracts(My Tasks) ###
    ...
    Scenario: Verify the Active Status of a contract
    ...
    Scenario: Verify the Registered Status of a Contract
        ...
        And Navigate to the Search Contracts
        And Search with Unique Identifier
        And Validate Dashboard Task Status for REGISTERED "<RowNumber>"
        And Log out from Application
