Feature: As an Automation Tester, I want to verify and add adequate details for the accordions available on Individual Section Details page and also want verify Copy Sections functionality while creating a contract , using an automated script.
    ...
    Scenario: Verify Copy Sections for Binding Authority Agreement with DCA
        ...
        And Add Claims Reporting Interval and Maximum Period to Reporting and Aggregate Exposures for DCA Individual Section "<RowNumber>"
    ...
    @ignore155399
    Scenario: Verify Copy Sections for Service Company Contracts
    ...
    Scenario: Verify Copy Sections Coverholder Appointment Agreement and validate user can Generate MRCE for Endorsement
