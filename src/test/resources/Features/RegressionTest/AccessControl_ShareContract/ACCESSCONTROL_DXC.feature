Feature: As an Automation Tester, I want to verify the Access Control for the DXC User Type, using an automated script.


    Scenario: Verify the Access for DXC Read Only User Type
        ...
        And Log out from Application
                            ...
                            ### Login with DXC Read Only User ###
        Given Login as DXC User "<RowNumber>"
        Then Validate Create Contract availability for Read Only User
        
                            ### Navigate to Ongoing Task and Review Task ###
