Feature: As an Automation Tester, I want to verify the Share Contract funtionality for Coverholder,using an automated script.

    
    Scenario: Validate Share Contract and Endorsement funtionality for Coverholder
        ...
        And Log out from Application
                            ...
                            ### Login As Managerial Group User For Selected Coverholder ###
        ...
        And Log out from Application  
                            ...
                            ### Login As Child Group User For Selected Coverholder ###
        ...
        And Validate the Shared Contract on Ongoing Task Dashboard
                            ...
                            ### Navigate to Search Contracts and Review Coverholder ###
        And Navigate to the Search Contracts
        And Search and Navigate to Record "<RowNumber>"
        And Navigate to Associated tasks
        And Navigate to Review Task From Search Contract "<RowNumber>"
