Feature: As an Automation Tester, I want to verify the Share Contract funtionality for Brokers,using an automated script.

    Scenario: Validate Share Contract and Endorsement funtionality for Brokers
