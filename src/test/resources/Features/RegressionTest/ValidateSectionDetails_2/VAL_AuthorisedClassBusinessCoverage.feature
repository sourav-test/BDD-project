Feature: As an Automation Tester, I want to verify the Authorised Class and Business Coverage accordion on Individual section with validations, using an automated script.
    ...
    Scenario: Verify Authorised Class and Business Coverage Generic COB and Risk Code warning message and Deductibles Checkbox
        ...
        And Navigate to Individual Section Details
    ...
    Scenario: Verify the Generic COB when Coverholder does not have approval while Create Endorsement
        ...
        Then Edit Generic Class Of Business on Individual Section
    ...
    Scenario: Verify the Generic COB when Service Company does not have approval while Create Endorsement
