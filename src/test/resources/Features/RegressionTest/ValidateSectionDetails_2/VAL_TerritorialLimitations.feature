Feature: As an Automation Tester, I want to verify the Territorial Limitations accordion for Individual Section, Common Section and its related validations using an automated script
    ...
    Scenario: Verify Territorial Limits For Worldwide Excluding for Individual Section
    ...
    Scenario: Verify Territorial Limits For Worldwide Excluding for Common Section
    ...
    Scenario: Verify the Coverholder entered does not have approval for Risk Location Country Individual Section while Endorsement
    ...
    Scenario: Verify the Coverholder entered does not have approval for Risk Location Country Individual Section while Termination Endorsement
    ...
    Scenario: Verify the Service Company entered does not have approval for Risk Location Country Individual Section while Endorsement
