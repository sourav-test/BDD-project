Feature: As an Automation Tester, I want to verify that user is able to NTU a draft Contract and Endorsement using an automated script.


    Scenario: Verify user is able to made a Create Contract task Not Taken Up
    ...
    @ignore155399
    Scenario: Verify user is able to made a Endorsement task Not Taken Up
