Feature: As an Automation Tester, I want to verify the Contract Endorsement, using an automated script

    
    Scenario: Verify Endorsement Workflow for Active Contract
        ...
        Then Navigate to Review Task From Ongoing Task Dashboard
                            ...
                            ### Approve Review Task as Service Company Lead When Assigned to Default ###
        Then Approve the Review Task with comments "<RowNumber>"
        And Log out from Application
    ...
    Scenario: Verify Managing Agent is able to complete Endorsement for Active Contract and validate that user is able to Generate MRCE
    ...
    Scenario: Validate user is not able to submit Endorsement without filling mandatory details
    ...
    Scenario: Verify Endorsement Workflow with Amend for Registered Contract and validate user is able to Generate MRCE 
        ...
        And Navigate to Endorsement Review Task From Search Contract
                            ...
                            ### Return Endorsement Review Task as Syndicate Lead When Assigned to Default ###
        ...
        Given Login as Contract Creator "<RowNumber>"
                            ...
                            ### Navigate to Search Contracts and Endorsement Review Task Returned###
        And Navigate to the Search Contracts
        And Search and Navigate to Record "<RowNumber>"
        And Navigate to Associated tasks
        And Navigate to Endorsement Review Task From Search Contract
    
                            ### Agree the Endorsement Review Task Returned ###
        ...
        Given Login as Contract Creator "<RowNumber>"
                            ...
                            ### Navigate to Search Contracts and Endorsement Task ###
        And Navigate to the Search Contracts
        And Search and Navigate to Record "<RowNumber>"
        And Navigate to Associated tasks
        And Navigate to Endorsement Review Task From Search Contract
    
                            ### Amend the Endorsement Task ###
        Then Initiate Endorsement Amend "<RowNumber>"
        ...
        Then Navigate to Review Task From Ongoing Task Dashboard
                            ...
                            ### Approve Endorsement Review Task as Syndicate Lead When Assigned to Managing Agent ###
    ...
    Scenario: Verify Endorsement Workflow with Retract for Expired Contract
        ...
        And Navigate to Endorsement Review Task From Search Contract
                            ...
                            ### Disagree the Endorsement Review Task Returned ###
        Then Open the Review Task Returned
    ...
    Scenario: Validate the Removed Participant does not have access while creating Endorsement
    ...
    @ignore155399
    Scenario: Validate the newly added Participants does not have access while creating Endorsement NTU
        ...
        And Log out from Application
                            ...
                            ### Login as Service Company Read Write Submit User ###
        When Login as Service Company Operator "<RowNumber>"
