Feature: As an Automation Tester, I want to verify the validation for no gap in Renewal Dates and absence of original Coverholder/Service Company using an automated script.

    Scenario: To verify the validation of Gap in renewal dates and absence of original Coverholder
        ...
        Then Enter the Period From Date with gap for Renewal
        And Click Continue
        ...
        And Edit Orginal Coverholder For Renewal
