Feature: As an Automation Tester, I want to verify the functionality of Duplicate Contract using an automated script.


    Scenario: Verify the Duplicate Functionality for Active Contract
    ...
    Scenario: Verify the Duplicate Functionality for Lloyds User with Registered Contract
