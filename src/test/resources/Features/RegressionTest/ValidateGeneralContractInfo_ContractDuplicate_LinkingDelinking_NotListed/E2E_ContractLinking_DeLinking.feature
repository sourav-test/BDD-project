Feature: As an Automation Tester, I want to verify the functionality of Linking and Delinking Contract using an automated script.

    
    Scenario: Verify Broker and Lloyds User is able to Link and Delink a Contract and Validate the error for invalid Contract while linking
        ...
        Then Start Duplicate Workflow "<RowNumber>"
        ...
        Then Edit Period From Date and To Date For Link and Delink
        And Click Continue
        ...
        When Login as Contract Creator "<RowNumber>"
                            ...
                            ### Navigate to Search Contracts and Link the Contract ###
        And Navigate to the Search Contracts
        ...
        Then Link the Contract and Validate the Link Type as Renewed To
                            ...
                            ### Navigate to Search Contracts and DeLink the Contract ###
        And Navigate to the Search Contracts
        And Search and Navigate to Record For Linking Delinking "<RowNumber>"
        And Navigate To Linked Contracts
