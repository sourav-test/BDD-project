Feature: As an Automation Tester, I want to verify the Task and the Contract Statuses with Non Registered template applicable depending upon the present stage, details and activity log of a contract , using an automated script


    Scenario: Verify a Non-MVP contract type for Binding Authority Agreement

                            ### Pre Requisite Steps ###
        Given Agreement Template "Not Listed-Binding Authority Agreement"
    ...
    @ignore155399
    Scenario: Verify a Non-MVP contract type for Service Company Agreement

                           ### Pre Requisite Steps ###
        Given Agreement Template "Not Listed-Service Company Agreement"
        Given Contract Status "Active" 
