Feature: As an Automation Tester, I want to verify the functionality of Termination Endorsement using an automated script.

    
    Scenario: Validate the Termination Endorsement for Active Contract
        ...
        And Search and Navigate to Record "<RowNumber>"
                            ...
                            ### Create Termination Endorsement ###
        Then Start Termination Endorsement Workflow "<RowNumber>"
        Then Enter the Termination Endorsement Details "<RowNumber>"
        ...
        Then Validate Terminated status under Record "<RowNumber>"
        And Log out from Application
    ...
    Scenario: Verify Lloyds user can perform Termination Endorsement for Registered Contract
        ...
        When Login as Lloyds User "<RowNumber>"
    ...
    Scenario: Verify the Termination Endorsement Effective Date and Pop Up Validations
        ...
        And Navigate to the Search Contracts
        And Search with Unique Identifier
        Then Validate Dashboard Task Status for ACTIVE "<RowNumber>"
        And Search and Navigate to Record "<RowNumber>"

                            ### Create Termination Endorsement ###
        When Start Termination Endorsement Workflow "<RowNumber>"
        ...
        Given Login as Contract Creator "<RowNumber>"
                            ...
                            ## Navigate to Search Contracts ###
        And Navigate to the Search Contracts
        When Search and Navigate to Record "<RowNumber>"
